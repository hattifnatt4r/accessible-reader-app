...
export const dataExampleFiles: ReaderFileType[] = [
  { id: 1, folder: 'examples', filename: 'Book 1', person_id: 1, author_id: 1, title: 'Book Title', filetype: '', config: '', is_chat: false, person_1: null, person_2: null },
  { id: 2, folder: 'examples', filename: 'Book 2 long title long title long title', person_id: 1, author_id: 1, title: 'Book Title', filetype: '', config: '', is_chat: false, person_1: null, person_2: null },
  { id: 3, folder: 'examples', filename: 'Moomins', person_id: 1, author_id: 1, title: 'Moomins', filetype: '', config: '', is_chat: false, person_1: null, person_2: null },
  { id: 4, folder: 'examples', filename: 'Book 4', person_id: 1, author_id: 1, title: 'Moomins', filetype: '', config: '', is_chat: false, person_1: null, person_2: null },
  { id: 5, folder: 'examples', filename: 'Book 5', person_id: 1, author_id: 1, title: 'Moomins', filetype: '', config: '', is_chat: false, person_1: null, person_2: null },
  { id: 6, folder: 'examples', filename: 'Book 6', person_id: 1, author_id: 1, title: 'Moomins', filetype: '', config: '', is_chat: false, person_1: null, person_2: null },
];
